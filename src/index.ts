...
class Airly {
	...
	*/
	async nearestInstallations(lat: number, lng: number, maxDistanceKM = 3, maxResults = -1): Promise<any> {
		// @ts-ignore
	...
	*/
	async installationInfo(id: number): Promise<any> {
		// @ts-ignore
	...
	*/
	async installationMeasurements(id: number): Promise<any> {
		// @ts-ignore
	...
	*/
	async nearestMeasurements(lat: number, lng: number, maxDistanceKM = 3): Promise<any> {
		// @ts-ignore
	...
	*/
	async pointMeasurements(lat: number, lng: number): Promise<any> {
		// @ts-ignore
	...
	*/
	async metaMeasurements(): Promise<any> {
		// @ts-ignore
